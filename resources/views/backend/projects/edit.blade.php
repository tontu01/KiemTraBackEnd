                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal store-update-entity" action="{{backendRouter('projects.update', ['id' => $entity->getKey()])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="name" value="{{ $entity->name }}" placeholder="Nhập tên dự án" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="country" value="{{ $entity->country }}" placeholder="Nhập quốc gia" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <img src="{{ asset($entity->avatar) }}" alt="" width="200px" class="mt-2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
